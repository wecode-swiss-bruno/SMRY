...
function applyHighlights(
      ...
      content.push(
        <span
          ...
          dangerouslySetInnerHTML={{
            __html: segmentHtml.slice(lastIndex, highlight.startIndex),
          }}
        />
      );
    }
  ...
  if (lastIndex < segmentHtml.length) {
    content.push(
      <span
        key="remaining"
        dangerouslySetInnerHTML={{ __html: segmentHtml.slice(lastIndex) }}
      />
    );
  }
...
const json = {
  ...
  segments: [
    ...
    },
    {
      ...
      segmentHtml:
        '<p id="article-summary">A wave of current and former staff members, mostly of a younger generation, are agitating for a cease-fire and speaking out against their bosses&#8217; positions.</p>',
      segmentType: "normal_text_short",
      hasSummary: false,
      highlights: [],
    },
    {
      ...
      segmentHtml:
        '<p><time datetime="2023-11-13T14:42:00-05:00"><span>Nov. 13, 2023</span><span>Updated <span>2:42 p.m. ET</span></span></time></p>',
      segmentType: "other",
      hasSummary: false,
      highlights: [],
    },
    {
      summary:
        "More than 10,000 carnations were laid on the steps at the base of the Capitol to honor civilians killed in the Israel-Hamas war. The flowers were brought over by more than 100 congressional staff members.",
      segmentText:
    ...
    {
      summary:
        "Three congressional aides declared they were no longer comfortable staying silent and demanded their leaders speak up and call for a cease-fire, a release of all hostages and an immediate de-escalation.",
      segmentText:
      ...
      segmentHtml:
        "<p>&#8220;We are congressional staffers on Capitol Hill, and we are no longer comfortable staying silent,&#8221; three of the aides, all of whom declined to give their names, declared, the Capitol dome towering behind them. &#8220;Our constituents are pleading for a cease-fire, and we are the staffers answering their calls. Most of our bosses on Capitol Hill are not listening to the people they represent. We demand our leaders speak up: Call for a cease-fire, a release of all hostages and an immediate de-escalation now.&#8221;</p>",
      segmentType: "normal_text",
      hasSummary: true,
      highlights: [
        {
    ...
    },
    {
      ...
      segmentHtml:
        "<p>The walkout was the latest in a series of actions congressional aides have taken, almost all of them anonymously, to publicly urge members of Congress &#8212; their own bosses &#8212; to call for a cease-fire in Gaza.</p>",
      segmentType: "normal_text_short",
      hasSummary: false,
      highlights: [],
    },
    {
      summary:
        "As a tense political debate rages across the country, a more personal and emotionally fraught discussion is taking place inside the offices of members of Congress.",
      segmentText:
    ...
    {
      summary:
        "The vast majority of lawmakers in both political parties have rejected calls for a cease-fire, saying a cessation would embolden Hamas and allow it to regroup.",
      segmentText:
    ...
    {
      summary:
        "Many Democratic congressional staff members are in stark disagreement with their bosses and the Biden administration on an issue that cuts to the heart of their values.",
      segmentText:
      ...
      segmentHtml:
        "<p>But many Democratic congressional staff members, most of them under the age of 35, have found themselves in stark disagreement with their bosses and the Biden administration on an issue that cuts to the heart of their values, according to interviews with more than a dozen aides and strategists, most of whom spoke on the condition that their names not be used for fear of imperiling their jobs and prompting personal attacks.</p>",
      segmentType: "normal_text",
      hasSummary: true,
      highlights: [
        {
    ...
    {
      summary:
        "Many aides on Capitol Hill have voiced dissenting opinions in internal meetings and on calls with constituents, and have concluded that they have no choice but to speak out.",
      segmentText:
    ...
    {
      summary:
        "For a lot of people, this is a red line, but the conversation on Capitol Hill is divorced from reality, said Jeremy Slevin, a senior adviser to Representative Ilhan Omar.",
      segmentText:
    ...
    {
      summary:
        "Staffers on Capitol Hill are divided over how far to go in criticizing Israel's military campaign.",
      segmentText:
    ...
    },
    {
      ...
      segmentHtml:
        "<p>The signers wrote that they were staying anonymous &#8220;out of concern for our personal safety, risk of violence and the impact on our professional credibility on Capitol Hill.&#8221;</p>",
      segmentType: "normal_text_short",
      hasSummary: false,
      highlights: [],
    },
    {
      summary:
        "500 former staff members of President Biden's 2020 campaign wrote an open letter calling for a cease-fire.",
      segmentText:
    ...
    {
      summary:
        "More than 400 former staff members signed a letter to Senator Elizabeth Warren and Senator Bernie Sanders calling for a cease-fire.",
      segmentText:
    ...
    {
      summary:
        "Ms. Warren said she is proud of people who fight for what they believe in, and that she is blessed to have people to work with who are smart, hardworking and passionate.",
      segmentText:
    ...
    {
      summary:
        "The debate over a cease-fire between Israel and Hamas has gotten hotter and messier in other congressional offices. Adam Ramer resigned after less than a week on the job when Representative Ro Khanna declined to call for a cease-fire.",
      segmentText:
    ...
    {
      summary:
        "Aides acknowledge that it's rare to find a member of Congress they align with on all policy issues, but the Israel-Hamas conflict has left them feeling ashamed of their work.",
      segmentText:
    ...
    {
      summary:
        "A staff member for a Democratic congresswoman who has not called for a cease-fire said she had fielded hundreds of messages from constituents, but was rebuffed when she raised the issue directly with the congresswoman.",
      segmentText:
    ...
    {
      summary:
        "Mr. Shahid said the discord was the result of a generational disconnect between the old guard of the Democratic Party and new generation of Democratic voters.",
      segmentText:
      ...
      segmentHtml:
        "<p>Mr. Shahid said the discord was the result of a generational disconnect that could hurt Democrats electorally in 2024.</p><span>&nbsp;&nbsp;</span><p>&#8220;The old guard of the Democratic Party has an outdated view of how unconditionally supportive their own voters are of Israel,&#8221; he said. &#8220;There&#8217;s a new generation of Democratic voters and electeds who want to be a bit more evenhanded when it comes to treating Israeli lives and Palestinian lives equally.&#8221;</p>",
      segmentType: "normal_text",
      hasSummary: true,
      highlights: [
        {
    ...
    },
    {
      summary: null,
      segmentText:
        "Congressional Aides Break With Bosses Over the Israel-Hamas War. Order Reprints | Today’s Paper | Subscribe",
      segmentHtml:
        '<p>Congressional Aides Break With Bosses Over the Israel-Hamas War<span>. <a href="https://www.parsintl.com/publication/the-new-york-times/">Order Reprints</a> | <a href="https://www.nytimes.com/section/todayspaper">Today&#8217;s Paper</a> | <a href="https://www.nytimes.com/subscriptions/Multiproduct/lp8HYKU.html?campaignId=48JQY">Subscribe</a></span></p>',
      segmentType: "other",
      hasSummary: false,
      highlights: [],
    },
